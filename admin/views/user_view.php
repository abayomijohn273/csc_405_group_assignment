		            			...
		            			<div class='card card-chart'>
									...
									$return .= "</tr>";
												...
												$return .= "<tr>
																<th></th>
																<td>
																	<form action='admin.php?ad_page=user_ctrl' method='post'>
																		<div class='col-md-10 input_div'>
																            <div class='form-group'>
																            	<input type='hidden' name='id' value='$userData->user_id'>
																                <label class='bmd-label-floating'>Executive office</label>
																                <input type='text' class='form-control' name='office'>
																                <button class='btn btn-primary' name='office_update'>
																                	Update
																                </button>
																            </div>
																        </div>
																        <small>Manage executive post.</small>
																	</form>
																</td>
															</tr>";
												}
