<?php
	...
	if($isEntryClicked){
		...
		$entryData = $entryTable->getEntryById($blog_id);
		$entriesR = $entryTable->getAllEntriesForSingleSide();

		$blogOutput = include_once "views/blog_single.php";
		...
		$blogOutput = include_once "views/news_v.php";
	}
    return $blogOutput;
?>